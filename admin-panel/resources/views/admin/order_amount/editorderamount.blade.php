                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text"name="min_value" value="{{$city->min_value}}" class="form-control" required>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text"name="max_value" value="{{$city->max_value}}" class="form-control" required>
                        </div>
                      </div>
