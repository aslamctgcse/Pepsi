...
<div class="col-lg-12">
    <div class="row">
	 <form action="{{route('store_cancelled')}}" method="GET" style="display: contents;" >
	   <div class="col-md-3">
	   ...
	   <div class="col-md-3">
		 ...
		 <a href="{{route('store_cancelled')}}"  class="btn btn-danger" >Reset</a>
	   </div>
	   </form>
	</div>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ucwords($ords->user_name)}}<p style="font-size:14px">({{$ords->user_phone}})</p></td>
