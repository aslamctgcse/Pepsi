...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$ords->user_name}}<br/>({{$ords->user_phone}})</td>
            ...
            <td class="td-actions text-right">
                ...
                <p>Confirmed</p>
                @endif
                @if($ords->order_status == 'Out_For_Delivery'||$ords->order_status == 'out_for_delivery'||$ords->order_status == 'Out_for_delivery'||$ords->order_status == 'out_for_delivery')
                ...
                @if($ords->order_status == 'Completed'||$ords->order_status == 'completed'||$ords->order_status == 'Completed'||$ords->order_status == 'complete')
                  <p>Completed</p>
                @endif
                @if($ords->order_status == 'Cancelled'||$ords->order_status == 'cancelled'||$ords->order_status == 'Canceled'||$ords->order_status == 'canceled')
                  <p>Cancelled</p>
                @endif
