                         ...
                         @if(count($city)>0)
                          ...
                          @foreach($city as $cities)
                            <tr>
                                ...
                                <td> {{$cities->store_discount??'NA'}} </td>
                                ...
                                <td class="td-actions text-center">
                                    ...
                                    <a href="{{route('storedit', $cities->store_id)}}"  button type="button" class="btn btn-success ">
                                     ...
                                     <a href="{{route('storedelete', $cities->store_id)}}" data-name="store" button type="button" class="btn btn-danger delete-confirm-event">
