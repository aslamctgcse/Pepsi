                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" onkeypress="return numbersonly(event)" name="boy_phone" maxlength="10" class="form-control" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="boy_licence_number" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Delivery Boy Licence Image</label>
                          <input type="file" name="licence_image" class="form-control-file" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="boy_identification" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Delivery Boy Identification Image</label>
                          <input type="file" name="identification_image" class="form-control-file" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="medical_data" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Life Insurence Number*</label>
                          <input type="text" name="life_insurence_number" class="form-control" required>
                        </div>
                      </div>
                    </div>
