...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$d_boys->store_name}}</td>
            @if($d_boys->is_engaged == 1)
            ...
            @endif
            <td><a href="{{route('admin_dboy_orders',$d_boys->dboy_id)}}" rel="tooltip" class="">
                    <i class="material-icons">layers</i></td>
            <td class="td-actions text-right">
                <a href="{{route('location_track',$d_boys->dboy_id)}}" rel="tooltip" class="btn btn-success">
                    <i class="material-icons">location_on</i>
                </a>
                <a href="{{route('EditD_boy',$d_boys->dboy_id)}}" rel="tooltip" class="btn btn-success">
                    <i class="material-icons">edit</i>
                </a>
               <a href="{{route('DeleteD_boy',$d_boys->dboy_id)}}" rel="tooltip" data-name="delivery boy" class="btn btn-danger delete-confirm-event">
