    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="td-actions text-right">
                ...
                @else
                  <a href="{{ route('categoryUnblock',$cat->cat_id) }}" rel="tooltip" class="btn btn-primary">
            ...
            <td class="td-actions text-right">
               ...
               <a href="{{route('DeleteCategory',$cat->cat_id)}}" rel="tooltip" data-name="category" class="btn btn-danger delete-confirm-event">
