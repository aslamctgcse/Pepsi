...
<div class="col-lg-12">
   ...
   <div class="alert alert-success">
    ...
    <div class="col-lg-12">  
     <a href="{{route('AddSubCategory')}}" class="btn btn-primary ml-auto" style="float:right;padding-top: 3px"><i class="material-icons">add</i>Add Sub Category</a>
   </div> 
<div class="col-lg-12">
<div class="card">    
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="td-actions text-right">
               ...
               <a href="{{route('DeleteCategory',$cat->cat_id)}}" rel="tooltip" data-name="sub category" class="btn btn-danger  delete-confirm-event">
...
<div class="pagination justify-content-end" align="right" style="width:100%;float:right !important">{{-- $subcategory->links() --}}</div>
</div>
