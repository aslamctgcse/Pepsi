            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body" style="border-bottom: 2px solid grey;margin-bottom: 15px">
                  ...
                  <form class="forms-sample" action="{{route('addBulkProduct')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="file"name="products_csv" class="form-control fmext file" required accept=".csv" >
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="quantity" class="form-control" required step=".01">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
