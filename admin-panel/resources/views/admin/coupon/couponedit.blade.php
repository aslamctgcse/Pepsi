          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{$coupon->coupon_name}}" name="coupon_name" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{$coupon->coupon_description}}"  name="coupon_desc" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group is-filled">
                          ...
                          <select name="store_id" class="form-control" required>
                            ...
                            <option value="{{$store->store_id}}" {{ $store->store_id == $coupon->coupon_store_id ? 'selected="selected"' : '' }}>{{$store->store_name}}</option>
                            @endforeach
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" value="{{ date('Y-m-d\TH:i', strtotime($coupon->start_date)) }}" name="valid_to" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" value="{{ date('Y-m-d\TH:i', strtotime($coupon->end_date)) }}" name="valid_from" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="number" value="{{$coupon->cart_value}}" name="cart_value" class="form-control" required>
                        </div>
                      </div>
                    </div>
                    <br>
                ...
                <select class="form-control form-control-sm img" id="exampleFormControlSelect3" value="{{$coupon->type}}"  name="coupon_type" required>
                     ...
                     <input type="number" class="form-control " id="exampleInputName1" value="{{$coupon->amount}}" name="coupon_discount" placeholder="Enter discount" required>
                    </div>
                </div>
                  <div class="col-md-6">
                        <div class="form-group">
                           <label for="exampleFormControlSelect3">Uses Restriction*</label>
                          <input type="number" name="restriction" class="form-control" value="{{$coupon->uses_restriction}}" required>
                        </div>
                      </div>
            </div>
