              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="coupon_desc" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                    <div class="form-group">
                    <p class="card-description">Discount*</p>
                    <select class="form-control form-control-sm img" id="exampleFormControlSelect3" name="coupon_type" required>
                       <option values="">Select</option>
                      <option value="percentage">Percentage</option>
                      <option value="price">Price</option>
                      
                    </select>
                     <input type="number" class="form-control des_price" id="exampleInputName1" name="coupon_discount" placeholder="Enter discount" required>
                    </div>
                </div>
                  <div class="col-md-6">
                        <div class="form-group">
                           <p class="card-description">Uses Restriction*</p>
                          <input type="number" name="restriction" class="form-control" placeholder="maximum uses per user" required>
                        </div>
                      </div>
            </div>
