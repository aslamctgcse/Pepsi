                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" name="valid_from"  value="{{ date('Y-m-d\TH:i', strtotime($deal_p->valid_from)) }}"  class="form-control">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" name="valid_to" value="{{ date('Y-m-d\TH:i', strtotime($deal_p->valid_to)) }}"  class="form-control">
                        </div>
                      </div>
