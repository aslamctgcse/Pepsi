                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="min_amt" value="{{($prv->min_amt)}}" class="form-control" required>
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Minimum Days(*)</label>
                          <input type="text" name="min_days" value="{{($prv->min_days)}}" class="form-control" required>
                        </div>
                      </div>
