                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="currency_name" value="{{($currency->currency_name)}}" class="form-control"  required>
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Currency Sign*</label>
                          <input type="text" name="currency_sign" value="{{($currency->currency_sign)}}" class="form-control" required>
                        </div>
                      </div>
