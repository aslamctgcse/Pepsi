    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="td-actions text-right">
                ...
                <a href="{{route('store_confirm_order', $ords->cart_id)}}" data-toggle="modal" data-target="#exampleConfirmModal1{{$ords->sub_order_id}}" rel="tooltip" class="btn btn-success conAssCss">
                  Confirm And Assign
                </a>
        	...
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
						...
						<a style="color:#fff;cursor:pointer;"class="badge badge-success" onclick="openWin()">Print</a>&nbsp;&nbsp;
						<a style="color:#fff;cursor:pointer;"class="badge badge-primary" onclick="closeWin()">Close Window</a>
...
function openWin() {
  myWindow = window.open("{{route('print_order_details',$ords->cart_id)}}", "_blank", "width=auto, height=auto");
}
...
function closeWin() {
 ...
 <!--/////////dboy assign model//////////-->
@foreach($ord as $ords)
        <div class="modal fade" id="exampleConfirmModal1{{$ords->sub_order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
