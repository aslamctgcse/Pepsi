...
<head>
  ...
  <link href="{{url('assets/css/custom-store.alobha.css')}}" rel="stylesheet" />
  <style>
...
<!--footer-->
 ...
 <!--fixed plugin-->
  ...
  <script type="text/javascript">
    ...
    //added code for global search beg 
    //datatable initialise
    
    $(function (){
      var table =$('.table').DataTable({
          //'paging'      : false, //old commented by me
          'paging'      : true,
          'lengthChange': true,
          'searching'   : true,
          'info'        : true,
    ...
    //added code for global search end
  ...
  // ===========Select2============
    //$('select').select2(); //commented by me
    $('.catsearch').select2(); 
    $('.catfilter ').select2(); 
