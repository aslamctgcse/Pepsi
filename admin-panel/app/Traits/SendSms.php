...
trait SendSms {
    ...
    public function otpmsgSendUser($otpval, $user_phone)
    {
        $getInvitationMsg = urlencode("Your OTP is: ".$otpval.".\n Note: Please use this otp at time of delivery."); 
     
        $this->hitOTPAPI($getInvitationMsg, $user_phone);
    }
    
    public function otpmsgSendDriver($otpval, $user_phone)
    {
        $getInvitationMsg = urlencode("Confirmation OTP is: ".$otpval.".\n Note: Please use it for verify at time user delivery."); 
    ...
    public function otpmsg($otpval, $user_phone) 
    {
        ...
        // $getInvitationMsg = "Your OTP is: ".$otpval.".\nNote: Please DO NOT SHARE this OTP with anyone.";  // for twillo and msg91
...
//////Store Payout////////
 ...
 public function sendrejectmsg($cause,$user,$cart_id) {
    ...
    if($smsby->status==1){       
     ...
     #new added code by me to send sms beg
    public function sendordermsg($otpval, $user_phone)

    {

       // $getInvitationMsg = urlencode("Your otp is: ".$otpval.".\n Note: Please DO NOT SHARE this otp with anyone."); 
        $getInvitationMsg = urlencode($otpval); 

     

        $this->hitOTPAPI($getInvitationMsg, $user_phone);
        //$this->hitOTPAPI($getInvitationMsg,'9971665388');
