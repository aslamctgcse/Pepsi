...
class AssignorderController extends Controller
{
    ...
    public function printOrders($id)
	{
        ...
        //dd($ord);     
         ...
         $details  =   DB::table('sub_orders')
          ...
          $store_id = $store->store_id;
		return view('store.orders.printorders',compact('title','logo','ords','store','details'));         
	}
    ...
    public function notDeliveredOrdersReason(Request $request)
    {
       ...
       return view('store.orders.notdeliveredorders', compact('title','logo','ord','store','details','nearbydboy','urlMain'));         
    }
