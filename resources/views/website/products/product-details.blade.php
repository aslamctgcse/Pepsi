         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 d-lg-block d-none">
							   ...
							   <div class="card-body card-shop-filters">
								  <form class="form-inline mb-3">
									 <div class="form-group d-flex">
										<input type="text" class="form-control w60-percent" placeholder="Search By Category" style="border-top-right-radius: 0;    border-bottom-right-radius: 0;">
										<button type="submit" class="pl-2 pr-2 btn btn-secondary btn-lg" style="border-bottom-left-radius: 0 !important;    border-top-left-radius: 0 !important;margin-left: -1px;"><i class="mdi mdi-file-find"></i></button>
									 </div>
								  </form>
               	...
               	<div class="col-lg-9">
                  	<a href="#">
                  		<img class="img-fluid mb-3" src="{{ url('assets/website/img/shop.jpg') }}" alt="">
                  	</a>
	                <div class="shop-head">
	                    <a href="#">
	                    	<span class="mdi mdi-home"></span> Home
