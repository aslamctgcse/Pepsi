 ...
 <link href="https://irfandurmus.com/assets/star-rating/rating.css" rel="stylesheet" type="text/css">
    ...
    @endif
         ...
         <div class="container">
                        ...
                        <div class="card card-body account-right">
                           ...
                           <div class="widget">
                              ...
                              $orderno=$year.$month.$date.'-'.$orderid->order_id;
                                   ...
                                   {{'Order id-'.$orderno }}{{' ( Payment mode: '.strtoupper($orderid->payment_method ?? '').')'}} 
                                    ...
                                    <tbody>
                                     ...
                                     @foreach($orderproducts as $orderproduct)
                                       ...
                                       <tr>
                                          ...
                                          <td>₹{{$orderproduct->price * $orderproduct->qty}}
                              ...
                              <td>
                                ...
                                <?php }else{ ?>
                                  <i class="fa fa-times" aria-hidden="true" data-toggle="modal" data-target="#cancelmodal{{$orderproduct->varient_id}}" style="cursor:pointer;"></i>
                                <?php } ?>  
            ...
            <div class="modal fade" id="cancelmodal{{$orderproduct->varient_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                           ...
                           <div class="form-group" style="text-align: center;">
                            ...
                            <input  type="button" class="btn btn-primary mb-2" data-dismiss="modal" aria-label="Close" value="No">
                              ...
                              @endif
                                      ...
                                      ?>
                                          <th colspan="6">Order Total{{-- $discount_text --}} </th>
...
<div class="modal fade" id="cancelmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body newModalCss">
        <div class="delete_order">
           <form method="post" action=" @if(isset($orderproduct->order_cart_id))  {{url('/delete_order/'.$orderproduct->order_cart_id)}} @endif" enctype="multipart/form-data">
            {{csrf_field()}}
                <!-- <div class="form-group">
                    <label for="exampleFormControlTextarea1">Reason for Cancellation</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cancel_reason"></textarea>
