                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="min_cart_value" value="{{$reward->min_cart_value}}" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="reward_points" value="{{$reward->reward_point}}" class="form-control" required>
                        </div>
                      </div>
                    </div>
