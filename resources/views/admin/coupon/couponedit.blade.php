            ...
            <div class="col-md-12">
              <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" value="{{$coupon->start_date}}" name="valid_to" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="datetime-local" value="{{$coupon->end_date}}" name="valid_from" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                ...
                <select class="form-control form-control-sm img" id="exampleFormControlSelect3" value="{{$coupon->type}}"  name="coupon_type" required>
                     ...
                     <input type="text" class="form-control " id="exampleInputName1" value="{{$coupon->amount}}" name="coupon_discount" placeholder="Enter discount" required>
                    </div>
                </div>
                  <div class="col-md-6">
                        <div class="form-group">
                           <label for="exampleFormControlSelect3">Uses Restriction*</label>
                          <input type="text" name="restriction" class="form-control" value="{{$coupon->uses_restriction}}" required>
                        </div>
                      </div>
            </div>
