            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="city"  required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  id="autocomplete" name="society" placeholder="Society Name" required><br>
