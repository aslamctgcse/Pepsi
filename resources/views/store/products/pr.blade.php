                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <form class="forms-sample" action="{{route('stock_update', $sel->p_id)}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-md-8 pl-0" style="float:left">
                             <div class="form-group">
                              <label class="bmd-label-floating">stock</label>
                              <input type="number" name="stock" min="0" class="form-control" onkeypress="return numbersonly(event)" value="0">
                            </div>
                          </div>
                            <div class="col-md-4" style="float:left;margin-left: -20px;">
                             <button type="submit" style="border-radius: 20px;"><i class="fa fa-plus"></i></button>
                            </div>
                          </form>
                          </div>
                        </td>
