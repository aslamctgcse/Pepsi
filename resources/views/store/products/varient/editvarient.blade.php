            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('st_vupdate-varient', $varient_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                     <div class="row">
                    ...
                    <div class="row">
                     ...
                     <img src="{{url('/admin-panel/'.$product->varient_image)}}" alt="image" name="old_image" style="width:100px;height:100px; border-radius:50%">
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form">
                    ...
                    <a href="{{route('st_varient',$product->product_id)}}" class="btn">Close</a>
