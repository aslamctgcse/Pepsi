...
@foreach($ord as $ords)
        <div class="modal fade reasonModal" id="exampleReasonModal1{{$ords->not_del_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
        				<h4 class="modal-title" id="exampleModalLabel">Reason</h4>
        					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
        						<span aria-hidden="true">&times;</span>
        					</button>
        			</div>
                ...
                <div class="col-md-12">
                  ...
                  <p>
                    @if($ords->not_del_image!='N/A')
                     <img style="width:120px;height:120px; border-radius:8px" src="{{url('/').$ords->not_del_image}}" alt="{{$ords->not_del_id}}">
                    @endif
