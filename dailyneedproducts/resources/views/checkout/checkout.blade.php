                                       ...
                                       <!-- <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <select class="select2 form-control border-form-control" data-select2-id="7" tabindex="0" aria-hidden="false" name="ucountry">
                                                ...
                                                <option value="AX" data-select2-id="26">Åland Islands</option>
                                                ...
                                                <option value="CI" data-select2-id="79">Côte d'Ivoire</option>
                                                <option value="HR" data-select2-id="80">Croatia</option>
                                                <option value="CU" data-select2-id="81">Cuba</option>
                                                <option value="CW" data-select2-id="82">Curaçao</option>
                                                ...
                                                <option value="RE" data-select2-id="205">Réunion</option>
                                                ...
                                                <option value="BL" data-select2-id="209">Saint Barthélemy</option>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="form-group">
                                             ...
                                             <select class="select2 form-control border-form-control" data-select2-id="16" tabindex="0" aria-hidden="false" name="ubcountry">
                                                ...
                                                <option value="AX" data-select2-id="286">Åland Islands</option>
                                                ...
                                                <option value="CI" data-select2-id="339">Côte d'Ivoire</option>
                                                <option value="HR" data-select2-id="340">Croatia</option>
                                                <option value="CU" data-select2-id="341">Cuba</option>
                                                <option value="CW" data-select2-id="342">Curaçao</option>
                                                ...
                                                <option value="RE" data-select2-id="465">Réunion</option>
                                                ...
                                                <option value="BL" data-select2-id="469">Saint Barthélemy</option>
