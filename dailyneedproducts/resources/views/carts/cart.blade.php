                           ...
                           <tbody>
                             ...
                             $totalqty=0;
                              ...
                              <tr id="rp{{$product->id}}">
                                 ...
                                 <td class="cart_product">{{$product->pname}}</td>
                                ...
                                <!--  <td class="cart_description">
                                 ...
                                 <td class="availability in-stock">{{$product->quantity}} {{$product->unit}}</td>
...
<!--                                        </div>
 ...
 -->
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" class="">₹<span class="tp" id="tp1">{{$ordertotals}} </span></td>

                              </tr>

                              <tr>

                                 <td class="text-left" colspan="3"><strong style="color:red;" style="display: none;"></strong></td>
