...
trait SendSms {
    ...
    public function otpmsg($otpval,$user_phone) {
        $checkUser = DB::table('users')
                        ...
                        ->first();
        $getInvitationMsg = urlencode("Dear ".$checkUser->user_name." Your Dealwy OTP verification code is ".$otpval.".");
        $this->hitOTPAPI($getInvitationMsg, $user_phone);

        // $apiUrl = 'http://www.onex-ultimo.in/api/pushsms?user=NFDML&authkey=92A7YFf76gJU&sender=Dealwy&mobile='.$user_phone.'&text='.$getInvitationMsg.'&rpt=1&summary=1&output=json&entityid=1201160517117234073&templateid=1207163298064167575';
     ...
     public function otpmsg1($otpval,$user_phone) {
    ...
    //added code to send regisrter otp on mobile beg
    public function otpmsgregister($otpval, $user_phone){
    ...
    //added code to send regisrter otp on mobile end
    //added code to send sms of forget password beg
    public function sendpasswordotp($otpval, $user_phone,$user_name)

    {

        $getInvitationMsg = urlencode("Dear ".$user_name." Your Dealwy OTP verification code is ".$otpval."."); 
    ...
    public function hitOTPAPI($getInvitationMsg, $user_phone)

    { 
    //dd($user_phone.$getInvitationMsg);       

      # set sms gateway api.

      // $apiUrl = 'http://onextelbulksms.in/shn/api/pushsms.php?usr=623539&key=010Wiuw00NxS6ReGL7lxQbK8o9ktqi&sndr=alobha&ph='.$user_phone.'&text='.$getInvitationMsg.'&rpt=1&type=2';

      //   $apiUrl = 'http://onextelbulksms.in/shn/api/pushsms.php?usr=624138&key=010CN38V0Y6InS1m1fh3Pto0Y6Yio0&sndr=DrAzad&ph='.$user_phone.'&text='.$msgs.'&rpt=1&type=2';
    ...
    //added code to send sms of forget password end
