...
class SocietyController extends Controller
{
    ...
    public function society(Request $request)
    {
        ...
        $city = DB::table('city')
         ...
         $map ='AIzaSyAZbvJlKvTEKfrZmu5xdXhNdA6rwzDL5E8';  
    ...
    public function societyadd(Request $request)
    {
        ...
        $this->validate(
         ...
         $urlencode= str_replace(",","",$society);
                                ...
                                $response=json_decode(file_get_contents("https://maps.googleapis.com/maps/api/geocode/json?address=".$urlencode."&key=AIzaSyAZbvJlKvTEKfrZmu5xdXhNdA6rwzDL5E8"));
